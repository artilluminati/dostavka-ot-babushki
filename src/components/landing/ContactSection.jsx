...
export default function ContactSection({ className = "" }) {
    ...
    return (
        <section className={`base-container ${className}`} id="contact">
            <div className="flex justify-between gap-6">
                <div className="relative bg-brand pt-6 flex-grow w-[50cqw] rounded-4xl h-[500px] box-border flex items-end justify-center">
                    ...
                    <img
                        src={AbsoulteImg}
                        className="absolute top-6 max-w-[55cqw] blur-2xls"
                        alt=""
                    />
                </div>
                <div className="flex-grow w-[50cqw] pl-12 flex flex-col gap-y-9 justify-center">
                    <h3 className="font-black text-5xl">Свяжитесь с нами</h3>
                    <div className="flex gap-6 flex-col">
                        ...
                        <a
                            href="mailto:support@otbabushki.ru"
                        ...
                        <a
                            href="https://t.me/dostavkaotbabushki"
                            className={baseListClass}
                        >
                            <img src={TgIcon}></img>
